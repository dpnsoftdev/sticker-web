...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 cursor-pointer",
  {
    variants: {
      variant: {
        default:
          "bg-primary-bold text-white hover:bg-primary-bold/90 opacity-80",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-input bg-background hover:bg-primary-light hover:text-primary-foreground",
        secondary:
          "bg-secondary-bold text-secondary-foreground hover:bg-secondary-bold/80",
        ghost: "hover:bg-primary-light hover:text-primary-foreground",
        link: "text-primary-bold underline-offset-4 hover:underline",
      },
      size: {
